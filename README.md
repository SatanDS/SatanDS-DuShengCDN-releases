...
- 商业授权：客户侧支持安装商业授权 token、查看授权状态、展示节点/站点额度、在线激活、72 小时租约和自动续约。
- 开发者签发：授权客户信息、到期时间、节点额度、站点额度和功能能力由开发者专属签发端生成，客户面板不提供签发私钥和签发入口。
- 商业更新：面板右上角版本入口检查本仓库 Release；商业版从公开二进制 Release 更新，不暴露源码。
